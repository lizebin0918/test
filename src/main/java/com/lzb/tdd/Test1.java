...
public class Test1 {
    ...
    public static class PrintFizzBuzz {
        ...
        private static final Function<Integer, String> mod3 = n -> {
            if (isMod3.test(n)) return FIZZ;
            return "";
        };

        private static final Predicate<Integer> isMod5 = (n) -> n % 5 == 0;
        private static final Function<Integer, String> mod5 = n -> {
            if (isMod5.test(n)) return BUZZ;
            return "";
        };

        private static final List<Function<Integer, String>> FUNCTION_LIST = List.of(mod3, mod5);
